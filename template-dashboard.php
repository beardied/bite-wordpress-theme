                        ...
                        <div class="bite-site-card-fullwidth">
                            ...
                            <?php if ( $site_stats['total_impressions'] > 0 ) : ?>
                                <div class="bite-site-card-stats">
                                    ...
                                    <div class="bite-site-stat" title="Authority Index: <?php echo esc_attr( $dm->authority_index ); ?> / 100<?php echo $dm->opr_rank ? ' | OPR: ' . $dm->opr_rank : ''; ?><?php echo isset($dm->pagespeed_score) && $dm->pagespeed_score ? ' | D-Perf: ' . $dm->pagespeed_score : ''; ?><?php echo isset($dm->pagespeed_accessibility) && $dm->pagespeed_accessibility ? ' D-A11y: ' . $dm->pagespeed_accessibility : ''; ?><?php echo isset($dm->pagespeed_best_practices) && $dm->pagespeed_best_practices ? ' D-BP: ' . $dm->pagespeed_best_practices : ''; ?><?php echo isset($dm->pagespeed_seo) && $dm->pagespeed_seo ? ' D-SEO: ' . $dm->pagespeed_seo : ''; ?><?php echo isset($dm->mobile_score) && $dm->mobile_score ? ' | M-Perf: ' . $dm->mobile_score : ''; ?><?php echo isset($dm->mobile_accessibility) && $dm->mobile_accessibility ? ' M-A11y: ' . $dm->mobile_accessibility : ''; ?><?php echo isset($dm->mobile_best_practices) && $dm->mobile_best_practices ? ' M-BP: ' . $dm->mobile_best_practices : ''; ?><?php echo isset($dm->mobile_seo) && $dm->mobile_seo ? ' M-SEO: ' . $dm->mobile_seo : ''; ?>" style="cursor: help;">
                                        <span class="bite-site-stat-icon">🏆</span>
